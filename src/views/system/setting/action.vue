    ...
    data() {
      return {
        table: {
          ...
          loading: false,
          tableChangeList: [],
          columns: pageData.action.tableColumns
        },
        pageForm: {
          total: 0,
          index: 1,
    ...
    methods: Object.assign(func(), {
      func_dialog(action, row) {
        switch (action.routeKey) {
          case 'add':
            this.dialog = this.constructDialogData({ dialogData: pageData.action.dialog, title: '新增功能', apiKey: action.apiKey })
          ...
          case 'edit':
            ...
            this.dialog = this.constructDialogData({ dialogData: pageData.action.dialog, title: '修改功能', apiKey: action.apiKey, edit: true, ownData: row[0]})
            break
          default:
            break;
        }
