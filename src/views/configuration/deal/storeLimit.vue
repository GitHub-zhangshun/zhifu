  ...
  <div class="app-container">
    ...
    <el-dialog v-el-drag-dialog :title="dialog.title" :visible.sync="dialog.status" @close="dialogClose">
      <el-form :model="dialog.form" label-width="140px" :rules="rules" ref="form">
        <el-form-item label="用户单笔购买限制" prop="singleTime">
          <el-input v-model="dialog.form.singleTime" placeholder="用户单笔购买限制">
            <span slot="suffix">克</span>
          </el-input>
        </el-form-item>
        <el-form-item label="用户单日购买限制" prop="singleDay">
          <el-input v-model="dialog.form.singleDay" placeholder="用户单日购买限制">
            <span slot="suffix">克</span>
          </el-input>
        </el-form-item>
        <el-form-item label="平台单日购买限制" prop="platformDay">
          <el-input v-model="dialog.form.platformDay" placeholder="平台单日购买限制">
            <span slot="suffix">克</span>
          </el-input>
        </el-form-item>
      </el-form>
...
<script>
  ...
  export default {
    name: 'configuration-deal-storeLimit',
    components: {
      BusHeader,
      BusTable,
      BusPagination
    ...
    data() {
      return {
        ...
        table: {
          ...
          loading: false,
          tableChangeList: [],
          columns: pageData.storeLimit.tableColumns
        },
        pageForm: {
          total: 0,
          index: 1,
