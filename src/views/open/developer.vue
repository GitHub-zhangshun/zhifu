    ...
    data() {
      return {
        table: {
          ...
          loading: false,
          tableChangeList: [],
          columns: pageData.developer.tableColumns
        },
        search: {
          form: {},
          items: [{
    ...
    methods: Object.assign(func(), {
      func_dialog(action, row) {
        switch (action.routeKey) {
          case 'add':
            this.dialog = this.constructDialogData({ dialogData: pageData.developer.dialog, title: '新增用户', apiKey: action.apiKey })
          ...
          case 'edit':
            ...
            this.dialog = this.constructDialogData({ dialogData: pageData.developer.dialog, title: '修改用户', apiKey: action.apiKey, edit: true, ownData: row[0]})
            break
          default:
            break;
        }
