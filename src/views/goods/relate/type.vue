    ...
    methods: Object.assign(func(), {
      func_dialog(action, row) {
        switch (action.routeKey) {
          case 'add':
            this.dialog = this.constructDialogData({ dialogData: pageData.type.dialog, title: '新增分类', apiKey: action.apiKey })
          ...
          case 'edit':
            ...
            this.dialog = this.constructDialogData({ dialogData: pageData.type.dialog, title: '修改分类', apiKey: action.apiKey, edit: true, ownData: row[0] })
            break
          default:
            break;
        }
