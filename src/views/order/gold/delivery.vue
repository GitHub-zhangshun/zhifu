  ...
  export default {
    ...
    data() {
      return {
        table: {
          ...
          loading: false,
          tableChangeList: [],
          columns: pageData.delivery.tableColumns
        },
        pageForm: {
          total: 0,
          index: 1,
        ...
        dialog: {},
        tableListQuery: {
          status: ['gold_delivery_order_unsend', 'gold_delivery_order_sending', 'gold_delivery_order_waitgoods', 'gold_delivery_order_finish'],
          isDelivery: true
        }
      }
    },
    ...
    methods: Object.assign(func(), {
      getData_custom() {
        ...
        statusId && this.tableListQuery.status.push(statusId) || (this.tableListQuery.status = ['gold_delivery_order_unsend', 'gold_delivery_order_sending', 'gold_delivery_order_waitgoods', 'gold_delivery_order_finish'])
        this.getData()
      }
    })
  }
