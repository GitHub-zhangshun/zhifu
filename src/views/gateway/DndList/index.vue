        ...
        <div slot="header">
          <div class="header">
            <div class="title">
              ...
              <el-select v-model="gatewayInterfaces.search.form.ocelotId" placeholder="请选择网关">
            ...
            <div class="search">
              ...
              <el-input v-model="gatewayInterfaces.search.form.key" placeholder="apiKey"></el-input>
            </div>
          </div>
        </div>
        <div class="content">
          <draggable :list="gatewayInterfaces.list" :options="{group:'article'}" class="dragArea">
            <div v-for="element in gatewayInterfaces.list" :key="element.id" class="list-complete-item">
  ...
  export default {
    ...
    methods: {
      ...
      getGatewayInterfaces() {
        this.$request({
          url: this.hiddenActions['O_GATEWAY_INTERFACES'],
          data: {
            index: '1',
            size: '100000',
            ocelotId: this.gatewayInterfaces.search.form.ocelotId || null,
            key: this.gatewayInterfaces.search.form.key || null,
