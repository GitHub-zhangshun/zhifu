    ...
    data() {
      return {
        table: {
          ...
          loading: false,
          tableChangeList: [],
          columns: pageData.info.tableColumns
        },
        pageForm: {
          total: 0,
          index: 1,
    ...
    methods: Object.assign(func(), {
      func_dialog(action, row) {
        switch (action.routeKey) {
          case 'add':
            this.dialog = this.constructDialogData({ dialogData: pageData.info.dialog, title: '新增网关信息', apiKey: action.apiKey })
          ...
          case 'edit':
            ...
            this.dialog = this.constructDialogData({ dialogData: pageData.info.dialog, title: '修改网关信息', apiKey: action.apiKey, edit: true, ownData: row[0] })
            break
          default:
            break;
        }
